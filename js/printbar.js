...
let printbar = function() {
  ...
  let qr = "https://chart.googleapis.com/chart?cht=qr&chs=80x80&chl=" + document.URL + "&choe=UTF-8";

  let block = '<div class="printbar"><span class="heading">' + document.querySelector("h1").innerHTML + '</span><span>' + document.URL + '</span></div>';
